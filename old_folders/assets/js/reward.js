console.log("Reward Module Loaded");
...
const RewardModule = {
    ...
    bindEvents: function () {
        const searchInput = document.getElementById("search-reward");
        if (searchInput) {
    ...
    filterTable: function () {
        const query = document.getElementById("search-reward").value.toLowerCase();
